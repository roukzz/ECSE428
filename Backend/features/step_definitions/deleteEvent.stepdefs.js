...
When(
  "user requests to delete an event with eventid <eventid>",
  async function () {
...
Then(
  "the event is deleted with a confirmation message {string}",
...
Given(
  "the following user with username {string} is currently not logged in the system",
...
Then(
  "I should receive a confirmation that my operation was not successful with status code {string} for delete an event",
