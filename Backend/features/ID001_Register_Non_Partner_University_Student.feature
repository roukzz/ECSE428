Feature: Register as a New User (Non-Partner-University Student)
    ...
    As a Non-Partner-University Student
    ...
    Scenario Outline: Registering with a valid email and a valid password (Normal Flow)
    ...
    Scenario Outline: Registering with an invalid email OR invalid password (Error Flow)
